//
//  NSArray+QMBlocksKit.m
//  Module
//

#import "NSArray+QMBlocksKit.h"

@implementation NSArray (QMBlocksKit)
...
- (CGFloat)bk_reduceFloat:(CGFloat)initial withBlock:(CGFloat (^)(CGFloat, id))block
{
    NSParameterAssert(block != nil);
